...
void loop(std::ofstream &myfile, std::chrono::high_resolution_clock::time_point &t0, std::chrono::high_resolution_clock::time_point &t1) {
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        // Start going down and displaying data
            ...
            printf("areal %6d %6d %6d    ", (aaReal.x/8192), (aaReal.y/8192), (aaReal.z/8192));
            myfile << (aaReal.x/8192) << "," << (aaReal.y/8192) << "," << (aaReal.z/8192) << ",";
        #endif
            ...
            printf("aworld %6d %6d %6d    ", (aaWorld.x/8192), (aaWorld.y/8192), (aaWorld.z/8192));
            myfile << (aaWorld.x/8192) << "," << (aaWorld.y/8192) << "," << (aaWorld.z/8192);
        #endif
