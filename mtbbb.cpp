...
void loop(std::ofstream &myfile, std::chrono::high_resolution_clock::time_point &t0, std::chrono::high_resolution_clock::time_point &t1) {
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        // Start going down and displaying data
            ...
            printf("areal %6d %6d %6d    ", (static_cast<float>(aaReal.x) / 8192.0), (static_cast<float>(aaReal.y) / 8192.0), (static_cast<float>(aaReal.z) / 8192.0));
            myfile << (static_cast<float>(aaReal.x) / 8192.0) << "," << (static_cast<float>(aaReal.y) / 8192.0) << "," << (static_cast<float>(aaReal.z) / 8192.0) << ",";
        #endif
            ...
            printf("aworld %6d %6d %6d    ", (static_cast<float>(aaWorld.x) / 8192.0), (static_cast<float>(aaWorld.y) / 8192.0), (static_cast<float>(aaWorld.z) / 8192.0));
            myfile << (static_cast<float>(aaWorld.x) / 8192.0) << "," << (static_cast<float>(aaWorld.y) / 8192.0) << "," << (static_cast<float>(aaWorld.z) / 8192.0);
        #endif
