...
int buffer[SSD1306_LCDWIDTH * SSD1306_LCDHEIGHT / 8] = {
	...
	0xf8, 0xe0, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0xf0, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8,
	0xf8, 0x00, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8,
	0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0x00, 0x00, 0x00, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8,
	0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf0, 0xe0, 0x80, 0x00, 0x00, 0x00, 0xf8, 0xf8, 0xf8,
	0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf8, 0xf0, 0xe0, 0x80, 0x00,
	...
	0x7f, 0xff, 0xff, 0xfc, 0xf0, 0xe0, 0xf8, 0xff, 0xff, 0xff, 0x1f, 0xff, 0xff, 0xff, 0xff, 0xff,
	...
	,
...
void ssd1306_fillRect(int x, int y, int w, int h, int fillcolor)
{
	...
	switch (rotation) {
	case 1:
		// swap_values(x, y); NEED TO FIX THIS! NO FUNCTION
		// x = WIDTH - x - 1;
		break;
	case 2:
		x = WIDTH - x - 1;
...
void ssd1306_drawString(std::string str)
{
	int i, end;
	end = str.size();
	cursor_x = 0; // reset the cursor to the top left every time. Crude way of being able to type wherever. Need to fix with variables later.
	cursor_y = 0; // reset the cursor to the top left every time. Crude way of being able to type wherever. Need to fix with variables later.
	for (i = 0; i < end; i++)
		ssd1306_write(str[i]);
}
